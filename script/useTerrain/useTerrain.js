import { useTerrainGeneration } from './useTerrainGeneration.js';

const { createIsland, getNeighbors } = useTerrainGeneration();
let terrainMap = [[]];

export const useTerrain = () => {
  const updateTerrainMap = (gridSize) => {
  ...
  return { terrainMap, updateTerrainMap, getTerrainSprite };
};
