...
let ambientEffects = { entities: [] };

export const useTerrainGeneration = () => {
  const getNeighbors = (pos, useDiagonals) => {
  ...
  return { createIsland, getNeighbors, findEdges, ambientEffects };
};
